...
from .box_ops import box_cxcywh_to_xyxy, box_iou, generalized_box_iou, tube_cxcywh_to_xyxy, tube_iou, generalized_tube_iou
...
class RTDETRCriterionv2(nn.Module):
    ...
    def loss_labels_focal(self, outputs, targets, indices, num_boxes):
        ...
        src_logits = outputs['pred_logits'].to(torch.float64)
    ...
    def loss_labels_vfl(self, outputs, targets, indices, num_boxes, values=None):
        ...
        if values is None:
            ...
            ious, _ = tube_iou(tube_cxcywh_to_xyxy(src_boxes.view(src_boxes.size(0),-1,4)), tube_cxcywh_to_xyxy(target_boxes.view(target_boxes.size(0),-1,4)))
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes, boxes_weight=None):
        ...
        loss_giou = 1 - torch.diag(generalized_tube_iou(\
            tube_cxcywh_to_xyxy(src_boxes.view(src_boxes.size(0),-1,4)), tube_cxcywh_to_xyxy(target_boxes.view(target_boxes.size(0),-1,4))))
